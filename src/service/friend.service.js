...
module.exports = {
    ...
    */
    getCount: async (req) => {
        ...
        const outgoingRequestsCount = await friendInternal.getOutgoingRequestsCount(targetUserID);
        const incomingRequestsCount = await friendInternal.getIncomingRequestsCount(targetUserID);
        return {
            friendCount,
